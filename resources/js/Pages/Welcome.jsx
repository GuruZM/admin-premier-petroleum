...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    return (
        <>
            <Head title="Welcome" />
            <div class="border-4 border-red-500 min-h-screen  mx-auto">
			<div class="flex justify-center   ">
			 
				<div class="w-full border-4 border-red-600 h-screen flex">
				 
					<div
						class="w-full border-4 border-yellow-600 bg-gray-400 hidden lg:block lg:w-1/2 bg-cover rounded-l-lg"
						// style="background-image: url('https://source.unsplash.com/K4mSJ7kc0As/600x800')"
					></div>
				 
					<div class="w-full flex flex-col justify-center border-4 border-purple-800 lg:w-1/2 bg-white p-5 rounded-lg lg:rounded-l-none">
