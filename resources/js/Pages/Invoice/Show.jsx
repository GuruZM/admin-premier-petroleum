                    ...
                    <div>
                        ...
                        <div class="bg-white md:p-16 p-10">
                            <div class="flex   items-center justify-between gap-6">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold print:text-sm tracking-widest uppercase">
                            ...
                            <div class="overflow-x-auto">
                                <table class="border-gray-400 table-auto w-full text-sm mt-14 mb-12 whitespace-pre">
                                    ...
                                    <tbody class="bg-white">
                                        {invoice.line_items &&
                                            JSON.parse(invoice.line_items).map(
                                                (item, index) => (
                                                    <tr
                                                        key={index}
                                                        className={
                                                    ...
                                                    >
                                                        <td class="p-5 print:text-xs border-b border-gray-400 text-base font-medium">
                                                            {index + 1}
                                                        </td>
                                                        <td class="p-5 print:text-xs border-b border-gray-400 text-base font-medium">
                                                            {item.description}
                                                        ...
                                                        <td class="p-5 print:text-xs border-b border-gray-400 text-base font-medium text-center">
                                                            {item.rate}
                                                        </td>
