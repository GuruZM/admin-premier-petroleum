...
function Index({auth}) {
  ...
  return (
    ...
    <ContentLayout onOpen={redi} baseurl={baseurl} handleDelete={handleDelete} title="quotations" tableObject={quotations} tableColumns={quotationColumns} initialColumns={INITIAL_VISIBLE_COLUMNS}/>    
        <AddModal 
