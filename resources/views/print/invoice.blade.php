...
<body>
    ...
    <img 
    width="100%"
    src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/images/invoicebg.png'))) }} " alt="premier petroleum" >
 
   <div id="content">
    <div class="container">
        <div class="inline-item" style="  width:50%;padding-top:10px">
        ...
        <div class="inline-item" style="text-align:right">
            <h1 class="upper">Invoice No: #{{ $invoice->number }}</h1>
        </div>
    </div>
  
     
    <table style="padding-bottom:30px;padding-top:30px" >
        <tr>
        ...
        <tr>
            <td class="w-ha" style="width:20%">
                {{-- <img src="{{ asset('laraveldaily.png') }}" alt="cozyhouse" width="200" /> --}}
             
               <h1>
                {{ $invoice->customer->company_name }}
               </h1>
               <p class="tpin upper" style="margin:0">TPIN : {{ $invoice->customer->tpin }}</p>
            </td>
            <td class="w-h" style="width:35%;padding-right:20px">
                 
                <h1>{{ $invoice->customer->address }}</h1>
              
            </td>

            <td class="w-h" style="text-align:left;width:35%">
                <table style="text-align:right;margin-top:-25px">
                    <tr>
                        <td>
                            <h1 style="display: inline">Date:</h1> <br>
                            <h1 style="display: inline">Due Date:</h1> <br>
                            <h1 style="display: inline">Truck Details:</h1>
                        </td>
                        <td>
    ...
    <div class="margin-">
        <table class="products" id="items" >
            <tr id="header" style="padding-20px">
                ...
                @for ($i = 1; $i <= 7; $i++)
                    @if (isset($invoice->line_items[$i-1]))
                        <tr style="padding-top:5px">
                            ...
                            <td style="text-align:center ">
                                <h3>
                                {{ $invoice->line_items[$i-1]['description'] }}
                                </h3>
                            </td>
                            <td style="text-align:center">
                                <h3>
                                {{ $invoice->line_items[$i-1]['quantity'] }}

                                </h3>
                            </td>
                            <td style="text-align:center">
                                <h3>
                                {{ $invoice->line_items[$i-1]['rate'] }}
