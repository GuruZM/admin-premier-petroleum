...
<body>
    ...
    <img 
    width="100%"
    src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('/images/goodsreceivedbg.png'))) }} " alt="premier petroleum" >
    ...
    <div class="margin-">
        <table class="products" id="items" >
            <tr id="header" style="padding-20px">
                ...
                @for ($i = 1; $i <= 3; $i++)
                    @if (isset($goodsReceived->line_items[$i-1]))
                        <tr style="padding-top:5px">
                            ...
                            <td style="text-align:center ">
                                <h3>
                                {{ $goodsReceived->line_items[$i-1]['order_ref'] }}
                                </h3>
                            </td>
                            <td style="text-align:center">
                                <h3>
                                {{ $goodsReceived->line_items[$i-1]['description'] }}

                                </h3>
                            </td>
                            <td style="text-align:center">
                                <h3>
                                {{ $goodsReceived->line_items[$i-1]['quantity'] }}
        ...
        <div class="container" ">
            <div class="inline-item" style="  width:50%;margin-top:-300px">
                 <h1 class="upper">Received By:</h1>
                {{ $goodsReceived->received_by }}
            </div>
            {{-- <div class="inline-item">Item 2</div> --}}
            <div class="inline-item" style="text-align:right;padding-top:30px">
                <h1 class="upper">Checked By:</h1>
               
              {{ $goodsReceived->checked_by }}
            </div>
        </div>

        <div class="" style="text-align:left;padding-top:30px">
            <h1 class="upper">Condition Of Goods:</h1>
           
          {{ $goodsReceived->goods_condition }}
        </div>
